 ...
 *
 */
class SoftReferenceObjectPool!(T) extends BaseObjectPool!(T) {
     ...
     */
    SoftReferenceObjectPool(final PooledObjectFactory!(T) factory) {
     ...
     */
    override
    synchronized void returnObject(final T obj){
     ...
     */
    override
    synchronized void invalidateObject(final T obj){
        final PooledSoftReference!(T) ref = findReference(obj);
        if (ref == null) {
            throw new IllegalStateException(
    ...
    private PooledSoftReference!(T) findReference(final T obj) {
        ...
        while (iterator.hasNext()) {
            ...
            if (reference.getObject() != null && reference.getObject() == obj) {
                return reference;
            }
        }
        return null;
     ...
     */
    private void destroy(final PooledSoftReference!(T) toDestroy){
